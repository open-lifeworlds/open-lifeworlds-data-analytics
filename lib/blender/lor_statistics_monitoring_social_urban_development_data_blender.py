...
def blend_district_data(feature, area_sqkm, statistic_2_3_filtered, statistic_4_3_filtered):
    ...
    add_prop(feature, "s3_percentage_transfer_payments_recipients", statistic_2_3_filtered, "s3_anteil_transferbezieher")
    add_prop(feature, "s4_percentage_transfer_payments_recipients_below_15_years", statistic_2_3_filtered, "s4_anteil_transferbezieher_unter_15")
    ...
    add_prop(feature, "d3_percentage_transfer_payments_recipients", statistic_2_3_filtered, "d3_anteil_transferbezieher")
    add_prop(feature, "d4_percentage_transfer_payments_recipients_below_15_years", statistic_4_3_filtered, "d4_anteil_transferbezieher_unter_15")
    ...
    add_prop(feature, "k04_children_with_migration_background", statistic_4_3_filtered, "k04_kinder_und_jugendliche_mit_migrationshintergrund")
    add_prop(feature, "k05_inhabitants_with_migration_background", statistic_4_3_filtered, "k05_einwohnerinnen_und_einwohner_mit_migrationshintergrund")
...
def blend_district_region_data(feature, area_sqkm, statistic_2_2_filtered, statistic_4_2_filtered):
    ...
    add_prop(feature, "s3_percentage_transfer_payments_recipients", statistic_2_2_filtered, "s3_anteil_transferbezieher")
    add_prop(feature, "s4_percentage_transfer_payments_recipients_below_15_years", statistic_2_2_filtered, "s4_anteil_transferbezieher_unter_15")
    ...
    add_prop(feature, "d3_percentage_transfer_payments_recipients", statistic_2_2_filtered, "d3_anteil_transferbezieher")
    add_prop(feature, "d4_percentage_transfer_payments_recipients_below_15_years", statistic_2_2_filtered, "d4_anteil_transferbezieher_unter_15")
    ...
    add_prop(feature, "k04_children_with_migration_background", statistic_4_2_filtered, "k04_kinder_und_jugendliche_mit_migrationshintergrund")
    add_prop(feature, "k05_inhabitants_with_migration_background", statistic_4_2_filtered, "k05_einwohnerinnen_und_einwohner_mit_migrationshintergrund")
...
def blend_planning_area_data(feature, area_sqkm, statistic_1_filtered, statistic_2_1_filtered, statistic_3_filtered, statistic_4_1_filtered):
    ...
    add_prop(feature, "s3_percentage_transfer_payments_recipients", statistic_2_1_filtered, "s3_anteil_transferbezieher")
    add_prop(feature, "s4_percentage_transfer_payments_recipients_below_15_years", statistic_2_1_filtered, "s4_anteil_transferbezieher_unter_15")
    ...
    add_prop(feature, "d3_percentage_transfer_payments_recipients", statistic_2_1_filtered, "d3_anteil_transferbezieher")
    add_prop(feature, "d4_percentage_transfer_payments_recipients_below_15_years", statistic_2_1_filtered, "d4_anteil_transferbezieher_unter_15")
    ...
    add_prop(feature, "z_s3_percentage_transfer_payments_recipients", statistic_3_filtered, "z_s3_anteil_transferbezieher")
    add_prop(feature, "z_s4_percentage_transfer_payments_recipients_below_15_years", statistic_3_filtered, "z_s4_anteil_transferbezieher_unter_15")
    ...
    add_prop(feature, "z_d3_percentage_transfer_payments_recipients", statistic_3_filtered, "z_d3_anteil_transferbezieher")
    add_prop(feature, "z_d4_percentage_transfer_payments_recipients_below_15_years", statistic_3_filtered, "z_d4_anteil_transferbezieher_unter_15")
    ...
    add_prop(feature, "k04_children_with_migration_background", statistic_4_1_filtered, "k04_kinder_und_jugendliche_mit_migrationshintergrund")
    add_prop(feature, "k05_inhabitants_with_migration_background", statistic_4_1_filtered, "k05_einwohnerinnen_und_einwohner_mit_migrationshintergrund")
...
def add_prop(feature, property_name, statistics, statistics_property_name):
    if statistics_property_name in statistics:
        try:
            feature["properties"][f"{property_name}"] = int(statistics[statistics_property_name])
        except:
        ...
        try:
            ...
            if total_area_sqkm is not None:
                feature["properties"][f"{property_name}_per_sqkm"] = round(
                    int(statistics[statistics_property_name]) / total_area_sqkm)
        except:
            feature["properties"][f"{property_name}"] = 0
    ...
    def run(self, logger, data_path, statistics_path, results_path, clean=False, quiet=False):
        ...
        for statistic_bundle in pre_2020_statistics:
            ...
            extend_planning_areas(logger=logger,
                                  results_path=results_path,
                                  result_file_name=f"lor_planungsraeume_population_monitoring_social_urban_development_{year}.geojson",
